...
public class ReservationStationEntry {
	...
	long A; // address offset for load store in ID, holds effective address
			// after execution
	long result;
	...
	public ReservationStationEntry(String o, int r, int stage) {
		op = o;
		robIndex = r;
		this.stage = stage;
		busy = false;
	...
	public void setVj(long t, boolean src) {
		Vj = t;
		VjSrc = src;
	}

	public void setVk(long t, boolean src) {
		Vk = t;
		VkSrc = src;
	}

	public void setQj(long t, boolean src) {
		Qj = t;
		QjSrc = src;
	}

	public void setQk(long t, boolean src) {
		Qk = t;
		QkSrc = src;
	}

	public void setAddr(long a) {
		A = a;
	}
